...
{
    [Authorize]
    public class DCSGFuelStagedController : Controller
    {
        string Centralurl = WebConfigurationManager.AppSettings["CentralAPIUrl"];
        ...
        public FileResult Download(string id)
        {
            try
            {
                ...
                return File(FileName, System.Web.MimeMapping.GetMimeMapping(FileName), "DCSGstages.xlsx");
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex);
        ...
        public string GetFileName()
        {
            ...
            return dirInfo.FullName + @"\" + "DCSGStages.xlsx";
        }
        [HttpGet]
