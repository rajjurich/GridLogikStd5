...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		firstr = null;
	    var hTable = $("<table class='table table-bordered table-striped' style='width:" + ts.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(thead),
