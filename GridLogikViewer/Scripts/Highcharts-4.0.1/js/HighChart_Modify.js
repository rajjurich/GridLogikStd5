...
(function() {
    ...
    E = {
        ...
        global: {
            useUTC: !0,
            canvasToolsURL: "~/Scripts/Highcharts-4.0.1/js/modules/canvas-tools.js",
            VMLRadialGradientURL: "~/Scripts/Highcharts-4.0.1//vml-radial-gradient.png"
        },
        chart: {
            borderColor: "#4572A7",
            borderRadius: 0,
...
(function(m, C) {
    ...
    r(y, "getLabelPosition", function(a, b, c, d, e, f, g, k, l) {
        ...
        n.isRadial ? (a = n.getPosition(this.pos, n.center[2] / 2 + q(f.distance, -25)), f.rotation === "auto" ? d.attr({
            rotation: h
        }) : j === null && (j = n.chart.renderer.fontMetrics(d.styles.fontSize).b -
            d.getBBox().height / 2), i === null && (i = n.isCircular ? h > 20 && h < 160 ? "left" : h > 200 && h < 340 ? "right" : "center" : "center", d.attr({
            align: i
    ...
    h.boxplot = u(h.column, {
        ...
        drawPoints: function() {
            var a =
                ...
                c = a.options,
                d = a.chart.renderer,
                e, f, g, k, l, n, j, i, h, m, p, I, r, o, J, u, w, t, v, x, z, y, E = a.doQuartiles !== !1,
            ...
            s(b, function(b) {
                ...
                y = b.color || a.color;
                if (b.plotY !== C)
                    if (e = b.pointAttr[b.selected ? "selected" : ""], w = z.width, t = A(z.x), v = t + w, x = D(w / 2), f = A(E ? b.q1Plot : b.lowPlot), g = A(E ? b.q3Plot : b.lowPlot), k = A(b.highPlot), l = A(b.lowPlot), p.stroke = b.stemColor || c.stemColor || y, p["stroke-width"] = q(b.stemWidth, c.stemWidth, c.lineWidth), p.dashstyle =
                        b.stemDashStyle || c.stemDashStyle, o.stroke = b.whiskerColor || c.whiskerColor || y, o["stroke-width"] = q(b.whiskerWidth, c.whiskerWidth, c.lineWidth), u.stroke = b.medianColor || c.medianColor || y, u["stroke-width"] = q(b.medianWidth, c.medianWidth, c.lineWidth), u["stroke-linecap"] = "round", j = p["stroke-width"] % 2 / 2, i = t + x + j, m = ["M", i, g, "L", i, k, "M", i, f, "L", i, l], E && (j = e["stroke-width"] % 2 / 2, i = A(i) + j, f = A(f) + j, g = A(g) + j, t += j, v += j, I = ["M", t, g, "L", t, f, "L", v, f, "L", v, g, "L", t, g, "z"]), B && (j = o["stroke-width"] % 2 / 2, k += j, l += j, r = ["M", i - x * B,
                            k, "L", i + x * B, k, "M", i - x * B, l, "L", i + x * B, l
                        ]), j = u["stroke-width"] % 2 / 2, n = D(b.medianPlot) + j, J = ["M", t, n, "L", v, n], h) b.stem.animate({
                        d: m
    ...
    M.prototype.beforePadding = function() {
        ...
        this.tickPositions && (s(this.series, function(b) {
            ...
            if (h > 0)
                for (; c--;) typeof b[c] === "number" && (n = a.radii[c], d = Math.min((b[c] - k) * m - n, d), e = Math.max((b[c] - k) * m + n, e))
...
(function(j) {
    ...
    j.extend(n.prototype, {
        ...
        parseGoogleSpreadsheet: function() {
            ...
            c && jQuery.ajax({
                ...
                success: function(b) {
                    ...
                    for (l = 0; l < j; l++)
                        if (c = b[l], f = c.gs$cell.row - 1, k = c.gs$cell.col - 1, k >= i && k <= g && f >= e && f <= h) d[k - i][f - e] = c.content.$t;
                    a.dataFound()
                }
            })
        },
        ...
        parseTypes: function() {
            for (var a =
                    this.columns, b = a.length, c, d, e, h; b--;)
                for (c = a[b].length; c--;) d = a[b][c], e = parseFloat(d), h = this.trim(d), h == e ? (a[b][c] = e, e > 31536E6 ? a[b].isDatetime = !0 : a[b].isNumeric = !0) : (d = this.parseDate(d), b === 0 && typeof d === "number" && !isNaN(d) ? (a[b][c] = d, a[b].isDatetime = !0) : a[b][c] = h === "" ? null : h)
        },
        dateFormats: {
            "YYYY-mm-dd": {
        ...
        complete: function() {
            ...
            if (d.complete) {
                ...
                a.length > 1 && (b = a.shift(), this.headerRow === 0 && b.shift(), b.isDatetime ? c = "datetime" : b.isNumeric ||
                    (c = "category"));
                for (g = 0; g < a.length; g++)
                    if (this.headerRow === 0) a[g].name = a[g].shift();
                h = [];
                for (g = 0, k = 0; g < a.length; k++) {
                    e = j.pick(this.valueCount.individual[k], this.valueCount.global);
                    i = [];
                    if (g + e <= a.length)
                        for (f = 0; f < a[g].length; f++) i[f] = [b[f], a[g][f] !== void 0 ? a[g][f] : null], e > 1 && i[f].push(a[g + 1][f] !== void 0 ? a[g + 1][f] : null), e > 2 && i[f].push(a[g + 2][f] !== void 0 ? a[g + 2][f] : null), e > 3 && i[f].push(a[g + 3][f] !== void 0 ? a[g + 3][f] : null), e > 4 && i[f].push(a[g + 4][f] !== void 0 ? a[g + 4][f] : null);
                    h[k] = {
                        name: a[g].name,
                        data: i
                    };
