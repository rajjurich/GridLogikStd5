...
(function ($) {
    ...
    Jconfirm.prototype = {
        ...
        _buildHTML: function () {
             ...
             */
            this.$title = this.$el.find('.titlename');
            this.contentDiv = this.$el.find('div.contentbox');
    ...
    jconfirm.pluginDefaults = {
        template: '<div class="jconfirm"><div class="jconfirm-bg"></div><div class="jconfirm-scrollpane"><div class="container"><div class="row"><div class="jconfirm-box-container"><div class="jconfirm-box" role="dialog" aria-labelledby="labelled" tabindex="-1"><div class="closeIcon">&times;</div><div class="title-c"><span class="icon-c"></span><span class="titlename"></span></div><div class="content-pane"><div class="contentbox" style="margin-top:10px;margin-left:5px"></div></div><div class="buttons"></div><div class="jquery-clear"></div></div></div></div></div></div></div>',
        //template: '<div class="jconfirm"><div class="jconfirm-bg"></div><div class="jconfirm-scrollpane"><div class="container"><div class="row"><div class="jconfirm-box-container"><div class="jconfirm-box" role="dialog" aria-labelledby="labelled" tabindex="-1"><div class="closeIcon">&times;</div><div class="title-c"><span class="titlename"></span></div><div class="content-pane"><div class="contentbox" style="margin-top:10px;margin-left:5px"><span class="icon-c"></span></div></div><div class="buttons"></div><div class="jquery-clear"></div></div></div></div></div></div></div>',
        title: 'Hello',
        ...
        watchInterval: 100,
        columnClass: 'col-sm-5 col-sm-offset-3 col-xs-10 col-xs-offset-1',
