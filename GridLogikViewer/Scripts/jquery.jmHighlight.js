...
(function (global, factory){
	...
	jmHighlight.prototype.highlight = function(keyword_){
		...
		this.$elements = this.$elements.filter("*:not([data-jmhighlight],.label,.dataTables_empty)"); //changes added by Daniyal for not to highlight label on 19/02/2016
...
function Highlight()
{
    ...
    else if ($.fn.dataTable.isDataTable('#lsttable')) {
        //alert('lsttable');
