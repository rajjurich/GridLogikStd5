...
{
    [Authorize]
    public class ProfileLogController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            return View("ProfileLog", model);
        }

        [HttpPost]
        public async Task<ActionResult> Update(ProfileLogViewModel model)
        {
            ...
            using (WebClient client = new WebClient())
            {
                ...
                string s1 = client.UploadString(url + "ProfileLog", JsonConvert.SerializeObject(model));
                if (s1 != null)
                {
