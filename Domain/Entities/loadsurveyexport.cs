...
namespace Domain.Entities
{
    ...
    public partial class loadsurveyexport
    {
        ...
        public Nullable<double> rollover_kwh { get; set; }
        public Nullable<double> rollover_kvah { get; set; }
        public Nullable<double> rollover_kvarh_lag { get; set; }
        public Nullable<double> rollover_kvarh_lead { get; set; }
        public Nullable<int> missflag { get; set; }
    }
}
